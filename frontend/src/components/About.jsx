...
function About() {
  return (
    <>
      <Helmet>
        <title>About Aura Wellness | Your Partner in Health & Confidence</title>
        <meta
          name="description"
          content="Learn more about Aura Wellness—your trusted partner in health, wellness, and body confidence. Discover our mission, values, and the expert care we bring to every client journey."
        />
      </Helmet>
        ...
        <div className=" sm:w-3/4 bg-[#F0E9B0] mx-auto rounded-md pt-10 mb-10">
          <div className="px-2  mx-auto mt-6 rounded-md text-[#5C7463] ">
            ...
            <motion.p
              ...
              className="mb-3 sm:text-justify tracking-widest sm:text-2xl text-lg text-center"
            >
              Our dedicated team of professional, knowledgeable, and compassionate experts are here
              to support you and empower you in achieving your weight-loss goals. We are devoted to
            ...
            >
              ...
              confidence throughout your journey with us. Your health, happiness, and satisfaction
              are at the heart of everything we do, and we look forward to partnering with you on
              your path to a more vibrant and confident you.
            </motion.p>
            ...
            >
              ...
              <p className=" mt-1 text-center sm:w-1/2 sm:px-3 sm:text-2xl">
                ...
                extensive experience and expertise, Algery is dedicated to guiding you on your
                journey to a healthier and happier you. She combines medical precision with a caring
                touch, ensuring you receive the highest level of care in your weight-loss and
                aesthetic goals. Trust Algery Al-Hafi to lead you towards your wellness aspirations.
              </p>
            </motion.div>
              ...
              >
                ...
                <div className=" rounded-md shadow-xl h-[430px] text-center text-[#5C7463] border bg-white">
                  ...
                  <p className="text-center px-3 mb-5 text-xl">
                    ...
                    fat—no surgery, no downtime. Our personalized approach helps you target the
