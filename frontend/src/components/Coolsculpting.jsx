      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-12 text-[#F0E9B0] xl:mt-28">
        <section className="text-center space-y-4">
          ...
          <p className="text-[#F0E9B0] max-w-2xl mx-auto">
            Tired of stubborn fat that refuses to budge—no matter how clean you eat or how often you
            work out? At Aura Wellness, we offer CoolSculpting®, the world’s #1 non-invasive
        ...
        <Card className="bg-[#2e4033] text-[#F0E9B0]">
          <CardContent className="p-6 space-y-4">
            ...
            <p>
              ...
              naturally eliminated by your body over time—leaving you with a smoother, more sculpted
              silhouette.
            </p>
            <p>
        ...
        <Card className="bg-[#2e4033] text-[#F0E9B0]">
          <CardContent className="p-6 space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <Check className="text-[#8A9A5B]" size={20} /> Safe, non-invasive fat reduction with
                no downtime
              </li>
              <li className="flex items-start gap-2">
                <Check className="text-[#8A9A5B]" size={20} /> Quick in-office treatment—many areas
                done in under an hour
              </li>
              <li className="flex items-start gap-2">
                <Check className="text-[#8A9A5B]" size={20} /> Personalized treatment plans tailored
                to your body & goals
              </li>
              <li className="flex items-start gap-2">
        ...
        <Card className="bg-[#2e4033] text-[#F0E9B0]">
          <CardContent className="p-6 space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                <strong>Aftercare</strong> – Minimal side effects like numbness or redness may occur
                but usually resolve quickly.
              </li>
              <li>
        ...
        <div className="bg-[#2e4033] text-[#F0E9B0] p-6 rounded-2xl shadow-md ">
          ...
          <p className="mt-2">
            ...
            Petersburg, Clearwater, Wesley Chapel, Brandon, and surrounding communities. We’re your
            trusted local destination for non-surgical body sculpting and wellness.
          </p>
        </div>
