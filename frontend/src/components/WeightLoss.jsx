...
function WeightLoss() {
  return (
    <>
      <Helmet>
        <title>Medical Weight Loss with Semaglutide & Tirzepatide | Aura Wellness</title>
        <meta
          name="description"
          ...
          >
            ...
            >
              ...
              <p className=" text-2xl py-8 px-3 italic">
                ...
                weight loss goals, consider semaglutide. This injectable medication, taken once a
                week, offers a viable approach for addressing obesity and has garnered support from
          ...
          >
            ...
            >
              ...
              <p className=" text-2xl py-8 px-3 italic">
                ...
                injections, such as Tirzepatide, which effectively reduces food intake by lowering
                appetite, slowing the digestion of food in the stomach, and helping decrease body
                fat percentage.
              </p>
              <Link to="/contact-us">
        ...
        >
          ...
          >
            ...
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  Semaglutide works by mimicking the GLP-1 hormone. GLP-1 in higher amounts
                  interacts with the parts of the brain that suppress your appetite and signal you
                  to feel full. When used in conjunction with diet and exercise, it can cause
            ...
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  ...
                  Semaglutide injections as an integral part of our comprehensive weight loss
                  program. Semaglutide operates by emulating the effects of a hormone known as
                  GLP-1, which plays a role in regulating blood sugar and controlling appetite.
                  Through its appetite-reducing properties and the promotion of a sense of fullness,
                  Semaglutide can be a valuable tool in your weight loss journey. At Aura Wellness,
                  our team of healthcare professionals administers Semaglutide injections and
                  closely monitors your progress, adjusting your dosage as necessary to help you
            ...
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  Opting for a once-weekly Semaglutide dosage is preferred over daily regimens due
                  to its proven effectiveness and enhanced convenience for patients. With a longer
                  ...
                  once-weekly Semaglutide injection makes it a convenient and user-friendly choice
                  for individuals committed to realizing their weight loss objectives.
                </p>
              </Accordion.Content>
            </Accordion.Panel>
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  Semaglutide is a medication utilized for the treatment of obesity, and its cost
                  can be relatively high for several reasons. Firstly, the drug is relatively new to
                  the market, and limited availability often results in elevated prices.
                  Additionally, as an injectable medication, it involves additional manufacturing
                  processes, further contributing to its cost. Lastly, the relatively high price of
                  Semaglutide reflects its remarkable effectiveness, offering the potential for
                  substantial weight loss results for patients. Nevertheless, at Aura Wellness, we
                  provide cost-effective pricing options and tailor-made treatment plans, making
                  Semaglutide more accessible to individuals in need of this beneficial treatment.
                </p>
              </Accordion.Content>
            </Accordion.Panel>
            {/* <Accordion.Panel>
            ...
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  ...
                  in areas of the human brain important for appetite regulation. Tirzepatide has
                  been shown to decrease food intake and modulate fat utilization.
                </p>
              </Accordion.Content>
            </Accordion.Panel>
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  Tirzepatide works by activating both the GLP-1 and GIP receptors, which can lead
                  to increased feelings of fullness (satiety) and reduced food intake. This helps
            ...
            <Accordion.Panel>
              ...
              <Accordion.Content>
                <p className="mb-2 text-gray-500 dark:text-gray-400 text-xl">
                  ...
                  management purposes, in combination with dietary modifications and regular
                  exercise. This extended usage is considered for adults classified as obese (with a
                  BMI of 30 or higher) or overweight (with a BMI between 27 and 29), provided they
                  have at least one weight-related medical condition, such as high blood pressure or
                  high cholesterol.
                </p>
              </Accordion.Content>
            </Accordion.Panel>
