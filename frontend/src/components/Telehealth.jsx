    ...
    <div className=" sm:mt-20">
      ...
      >
        ...
        <div className="sm:w-2/3 mx-auto mt-14">
          <p className="  text-3xl font-bold text-navy ">EASY ACCESS TO OUR TEAM</p>
          ...
          <p className="  text-3xl font-bold text-navy">HOW IT WORKS</p>
          <ul className=" list-disc">
            <li className=" italic ml-10 text-xl pb-5 mt-5">
            ...
            <li className=" italic ml-10 text-xl pb-5">
          ...
          <p className="  text-3xl font-bold text-navy">SOME HELPFUL TIPS</p>
